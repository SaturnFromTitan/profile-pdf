...
class Profile(BaseModel):
    ...
    summary: list[str] = [
        '<span class="highlighted">Senior Quality & Test Engineer</span> and <span class="highlighted">Python Backend Developer</span> with over 10 years of experience. Combining deep technical expertise, a strong product mindset, and excellent communication skills.',
        "I am a very proactive engineer who values code quality, modern tooling, and always follows the latest best practises. I usually come in as the Python reference expert and modernize the applications by improve the tooling, ensuring testability, test coverage metrics, coding & deployment standards and the observability setup. By that I ensure decreased failure rates and increased developer productivity & happiness.",
    ]
    ...
    work_experience: list[WorkExperience] = [
        ...
        WorkExperience(
            ...
            description="Building a comprehensive test strategy and quality foundation for Vonovia's internal elevator IoT platform, enabling safe refactoring through reliable test coverage.",
            bullet_points=[
                "My role included writing application logic, testing it, deployment and monitoring for errors & performance",
                "Built test strategy for existing FastAPI system: prioritizing integration tests before refactoring & modernizing critical business logic",
                "Established integration tests in containerized environments (Docker) with reproducible test setups using testcontainers",
                "Introduced standardized test fixtures, test data management, and test utilities (mocking/stubbing) for a large legacy FastAPI codebase",
                "Established CI quality gates in Azure DevOps Pipelines",
                "Conducted API testing: HTTP, authentication, error-handling, and contract-testing",
                "Improved testability by working with backend team on interfaces, timeouts, and deterministic components in a large FastAPI codebase",
                "Used pytest extensively: fixtures, parametrization, markers, and well-structured test organization",
                "Introduced automated unit and integration tests in a previously untested/under-tested FastAPI codebase",
            ],
            technologies={
                "Python": [
                    "Alembic",
        ...
        WorkExperience(
            ...
            bullet_points=[
                "My role included writing application logic, testing it, deployment and monitoring for errors & performance",
                "Developed contract tests for public APIs (response format, error scenarios, deterministic checks)",
                "Established integration tests over FastAPI with reproducible test environments using testcontainers",
                "Established CI quality gates in GitHub Actions and SonarQube",
                "Conducted and analyzed load/performance tests for critical endpoints",
                "API testing: HTTP, authentication, error-handling, and contract-testing for FastAPI endpoints",
                ...
                "Used pytest extensively: fixtures, parametrization, markers, and well-structured test organization",
                "Documented best practises and stanards so they can be applied across teams",
            ],
            technologies={
                "Python": [
        ...
        WorkExperience(
            ...
            bullet_points=[
                ...
                "Built test strategy for greenfield system: established contract tests, integration tests, and critical business logic from the start",
                "Developed and maintained contract tests for APIs used by other production systems (response format, error scenarios, deterministic checks) using pytest",
                "Established integration tests in containerized environments (Docker) with reproducible test setups",
                "Introduced standardized test fixtures, test data management, and test utilities (mocking/stubbing) using pytest",
                "Conducted API testing: HTTP, authentication, error-handling, and contract-testing (OpenAPI/Swagger)",
                "Used pytest extensively: fixtures, parametrization, markers, and well-structured test organization",
                "Built reliable release process (CI/CD) with staging and production environments, ensuring quality gates",
            ],
            technologies={
                "Python": [
                    "Airflow",
