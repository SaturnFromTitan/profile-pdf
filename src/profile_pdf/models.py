...
class Profile(BaseModel):
    ...
    work_experience: list[WorkExperience] = [
        WorkExperience(
            ...
            location="Berlin",
            description="Platform to collect, process, and visualize hardware workload performance data against statistical baselines.",
            bullet_points=[
                "Built an event-driven real-time processing pipeline to ingest and parse incoming performance results",
                "Implemented a robust backfill feature to account for occasional downtime of dependencies",
                "Developed a scalable web application to visualize results against baselines",
                "Worked closely with data scientists to integrate the latest statistical methods into baseline comparisons",
            ],
            technologies={
                "Python": [
                    "Alembic",
